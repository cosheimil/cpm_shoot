...
cv2.createTrackbar('h2', 'settings', 255, 255, lambda y: y)
cv2.createTrackbar('s2', 'settings', 255, 255, lambda y: y)
cv2.createTrackbar('v2', 'settings', 255, 255, lambda y: y)
crange = [0, 0, 0, 0, 0, 0]
